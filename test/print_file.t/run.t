  ...
  module lib.mli
    ...
    Namespace: lib.mli
      ...
      Logic Symbols
        ...
        function mixfix [_.._] (_:integer) (_:integer) (_:integer) : integer
    ...
    Signatures
      ...
      (*@ function prefix + (i_1:integer): integer *)
      
      (*@ function infix ++ (i_2:integer) (j:integer): integer *)
      
      (*@ function mixfix [_.._] (i_3:integer) (j_1:integer) (k:integer): 
          integer
      *)
      ...
      val f1 : t -> t
      (*@ r_1:t = f1 i_5:t
          ensures ((r_1:t).m = (prefix +  (i_5:t).m):integer):prop*)
      
      val f2 : t -> t
      (*@ r_2:t = f2 i_6:t
          ensures let h:integer -> integer = (prefix + ):integer -> integer in ((
                  r_2:t).m = (apply 
      ...
      (*@ r_4:t = f4 i_8:t j_3:t
          ensures let h_1:integer -> integer = (infix ++ 
                  (i_8:t).m):integer -> integer in ((r_4:t).m = (apply 
                  h_1:integer -> integer (j_3:t).m):integer):prop*)
      
      val f5 : t -> t -> t -> t
      (*@ r_5:t = f5 i_9:t j_4:t k_1:t
          ensures ((r_5:t).m = (mixfix [_.._] 
                  (i_9:t).m (j_4:t).m (k_1:t).m):integer):prop*)
      
      val f5_1 : t -> t -> t -> t
      (*@ r_6:t = f5_1 i_10:t j_5:t k_2:t
          ensures let h_2:integer -> integer = (mixfix [_.._] 
                  (i_10:t).m (j_5:t).m):integer -> integer in ((r_6:t).m = (apply 

...
type axiom = { ax_name : Ident.t; ax_term : term; ax_loc : Location.t }

let axiom id t l = { ax_name = id; ax_term = t; ax_loc = l }
...
let fun_spec req ens var coer =
  { fun_req = req; fun_ens = ens; fun_variant = var; fun_coer = coer }
